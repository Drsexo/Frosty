...
- **Оптимізація при вимкненому екрані**: Автоматично вимикає вибрані з'єднання (Wi-Fi, Bluetooth, мобільні дані, геолокація) і очищає кешовані додатки після настроюваної затримки вимкнення екрана, а потім відновлює все при розблокуванні.
...
- **Системні твіки**: твіки ядра, системні Props, вимкнення розмиття, завершення логів, блокування відстеження.
...
| Завершення Wakelock при вимк. екрані | ✅ | ✅ |
| Заборона WAKE_LOCK | ❌ | ✅ |
...
В: Твіки ядра, Системні Props, Вимкнення розмиття, Завершення логів, Оптимізатор ОЗП і Deep Doze працюють без проблем. Для функцій GMS потрібні самі GMS.
