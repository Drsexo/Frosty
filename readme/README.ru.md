...
- **Оптимизация при выключенном экране**: Автоматически отключает выбранные соединения (Wi-Fi, Bluetooth, мобильные данные, геолокация) и очищает кэшированные приложения после настраиваемой задержки выключения экрана, а затем восстанавливает всё при разблокировке.
...
- **Системные твики**: твики ядра, системные Props, отключение размытия, завершение логов, блокировка отслеживания.
...
| Завершение Wakelock при выкл. экране | ✅ | ✅ |
| Запрет WAKE_LOCK | ❌ | ✅ |
...
О: Твики ядра, Системные Props, Отключение размытия, Завершение логов, Оптимизатор ОЗУ и Deep Doze работают без проблем. Для функций GMS требуются сами GMS.
