...
- **Ajustes del Sistema**: Ajustes del kernel, props del sistema, desactivación de desenfoque, terminación de registros, deshabilitación de rastreo.
...
| Terminación de Wakelock (pantalla apagada) | ✅ | ✅ |
| Denegar WAKE_LOCK | ❌ | ✅ |
...
R: Los Ajustes del Kernel, los Props del Sistema, la Desactivación de Desenfoque, la Terminación de Registros, el Optimizador de RAM y Deep Doze funcionan perfectamente. Las características de GMS requieren tener GMS instalado.
